...
i2 = 5240 # end setpoint (bits)
R = 104857.6  # ramp rate bits/s  
...
#a = 0.1              # fraction of total ramp used by beginning and end curved parts
#D = np.abs(i2-i1)/R  # ramp duration (s)
#D0 = (1-2*a)*D*fs    # of pts of linear part of ramp
#D1 = a*D*fs          # of pts of curved part of ramp
#L = int(D0)          # number of points in linear part of ramp
#M = int(D1)          # of points in beginning and end curved parts of ramp
