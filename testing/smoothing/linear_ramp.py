...
print("number of points in linear part of Ramp = %d" % L)
print("Number of points in curved part of Ramp = %d" % M)
print("Total Number of points in Ramp          = %d" % (L + 2*M))
...
while i < L+2*M:
    if i < M:
       ...
       sp1 = sp0 + dy0
       sp0 = sp1
       #print("i =", i, "dy0 =", dy0, "sp0 =", sp0, "sp1 =", sp1)
       Y[i] = sp1   
